...
[CreateAssetMenu(fileName = "EnvironmentalResponsibility", menuName = "Responsibilities/Environmental")]
public class EnvironmentalSO : ScriptableObject
{
    [TextArea(3, 10)]
    ...
    public readonly string illustrationName_1 = "environmental_responsibility_submission";
