...
[CreateAssetMenu(fileName = "Social", menuName = "Responsibilities/Social")]
public class SocialSO : ScriptableObject
{
    [TextArea(3, 10)]
    ...
    public int turn;
    public readonly string illustrationName_1 = "social_responsibility_submission";
}
