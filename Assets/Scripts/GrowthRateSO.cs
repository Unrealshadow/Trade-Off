...
[CreateAssetMenu(fileName = "GrowthRate", menuName = "Responsibilities/Growth Rate")]
public class GrowthRateSO : ScriptableObject
{
    [TextArea(3, 10)]
    ...
    public readonly string illustrationName_1 = "meeting_growth_rate_submission";
